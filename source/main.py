...
logger = logging.getLogger(__name__) # Inicializar un Logger con Logging.
...
logger.addHandler(archivo_logger_info)
logger.addHandler(consola_logger_info)
...
logger.addHandler(archivo_logger_debug)
logger.addHandler(consola_logger_debug)
